...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="jumbotron">
        <h2>ACERCA</h2>
        <p class="lead text-justify"> Proyecto Basico de creacion de web de vacantes de trabajo.
          Cualquier duda o comentario puedes enviarme un correo electrónico.<br> <br>         
          <b>Autor</b>: Bach. Huaringa Hurtado Jean Pierre<br>
          <b>Email</b>: jhingx1@gmail.com
        <p>
      </div>
