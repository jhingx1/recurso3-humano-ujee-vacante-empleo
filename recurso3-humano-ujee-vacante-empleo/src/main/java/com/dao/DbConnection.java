...
public class DbConnection {
	...
	/*
	 * Se declaran constantes, porque van a ser siempre los mismos valores cada
	 * vez que se vaya a crear un objeto de tipo DbConnection
	 */
	static String bd = "sistema-vacantes-db";
	...
	public DbConnection() {
		try {
			...
			// obtenemos una conexion con los parametros especificados
			// anteriormente
		...
		} catch (ClassNotFoundException e) // Excepcion ocurrida por no
											// encontrar el driver
		{
