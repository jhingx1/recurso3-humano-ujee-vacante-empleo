...
public class Mail {
   ...
   public String sendMail(String mailDestino, String Asunto, String Mensaje) {
      ...
      try {
         ...
         message.setFrom(new InternetAddress("jhingx1@gmail.com")); // debe ser la misma de la configuracion de arriba
         ...
         t.connect("jhingx1@gmail.com", "#sistemas#04"); // Esta es la contraseña de la cuenta de gmail que se usara para enviar el correo
         t.sendMessage(message, message.getAllRecipients());
         // Cierre.
         t.close();
         response = "El correo electronico fue enviado correctamente.";
         return response;
      } catch (Exception e) {
